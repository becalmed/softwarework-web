            ...
            <el-tab-pane label="用户资料" name="first">
              <el-form ref="form" :model="form" :rules="rules" style="margin-top: 10px;" size="small" label-width="65px">
                ...
                <el-form-item label="提醒方式">
                  <el-radio-group v-model="form.messageType" style="width: 35%;">
                    <el-radio label="站内消息">站内消息</el-radio>
                    <el-radio label="邮箱提醒">邮箱提醒</el-radio>
                  </el-radio-group>
                </el-form-item>
                <el-form-item label="">
...
export default {
  ...
  created() {
    this.form = { id: this.user.id, nickName: this.user.nickName, messageType: this.user.messageType,gender: this.user.gender, phone: this.user.phone }
