<template>
  ...
  <div class="login" :style="'background-image:url('+ Background +');'">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" label-position="left" label-width="0px" class="login-form">
      ...
      <a style="font-size:13px" @click="updatePwd">    忘记密码？点我找回</a>
    ...
    <!--  注册模块 -->
    <el-dialog :visible.sync="formVisible" title="注册" width="30%">
      <el-form ref="form" :model="form" :rules="formRules" label-width="100px">
        ...
        <el-form-item label="电话" prop="phone">
          <el-input v-model="form.phone" placeholder="请输入注册电话号码" />
        </el-form-item>
        ...
        <el-form-item>
          <el-button type="primary" @click="submitPassword">找回密码</el-button>
...
import { reg,updatePwd } from '@/api/system/user'
